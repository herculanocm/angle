...
var App = angular.module('angle', ['ngRoute', 'ngAnimate', 'ngStorage', 'ngCookies', 'pascalprecht.translate', 'ui.bootstrap', 'ui.router', 'oc.lazyLoad', 'cfp.loadingBar'])
          .run(["$rootScope", "$state", "$stateParams",  '$window','$modal', function ($rootScope, $state, $stateParams, $window, $modal) {
...
App.controller('SidebarController', ['$rootScope', '$scope', '$state', '$location', '$http', '$timeout', 'APP_MEDIAQUERY',
  function($rootScope, $scope, $state, $location, $http, $timeout, mq){
    ...
    $scope.toggleCollapse = function($index) {
        console.log('entrou no collapse');
      ...
      collapseList[$index] = !collapseList[$index];
        console.log('INDEX'+$index+ ' collapse '+collapseList[$index]);
      return true;
